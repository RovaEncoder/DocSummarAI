...
#     "science": "facebook/bart-large-cnn",  # Exemple de modèle compatible
...
#     """
#     Charge un modèle compatible avec le résumé en tenant compte du GPU.
#     """
...
#         raise HTTPException(
#             status_code=500,
#             detail=f"Le modèle {model_name} n'est pas compatible avec la tâche de résumé.",
#         )
